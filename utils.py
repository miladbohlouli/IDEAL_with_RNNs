# Todo:
#   1. Implement the sliding and the for loop of the system for future prediction
#   2. Implement the visualization of the temperature data
...
def visulaize(dates, target, predicted, figure_size=[20, 20], date_format=None, y_lim = None):
    ...
    if date_format is None: date_format = "%a %d.%m"
